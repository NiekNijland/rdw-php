    ...
    public static function schema(): DatasetSchema
    {
        return new DatasetSchema(
            ...
            fields: [
                ...
                new FieldDescriptor('brandstofverbruik_buiten', 'FuelConsumptionOuter', 'fuelConsumptionOuter', CastType::Decimal),
                new FieldDescriptor('brandstofverbruik_gecombineerd', 'FuelConsumptionCombined', 'fuelConsumptionCombined', CastType::Decimal),
                new FieldDescriptor('brandstofverbruik_stad', 'FuelConsumptionCity', 'fuelConsumptionCity', CastType::Decimal),
                ...
                new FieldDescriptor('roetuitstoot', 'SootEmissions', 'sootEmissions', CastType::Decimal),
                ...
                new FieldDescriptor('actie_radius_enkel_elektrisch_stad_wltp', 'WltpRangeElectricOnlyCity', 'wltpRangeElectricOnlyCity', CastType::Decimal),
                ...
                new FieldDescriptor('actie_radius_extern_opladen_stad_wltp', 'WltpRangeExternalChargingCity', 'wltpRangeExternalChargingCity', CastType::Decimal),
                new FieldDescriptor('max_vermogen_15_minuten', 'MaximumPower15Minutes', 'maximumPower15Minutes', CastType::Decimal),
                new FieldDescriptor('max_vermogen_60_minuten', 'MaximumPower60Minutes', 'maximumPower60Minutes', CastType::Decimal),
